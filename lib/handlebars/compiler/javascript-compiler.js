...
JavaScriptCompiler.prototype = {
  ...
  registerDecorator(paramSize, name) {
    ...
    this.decorators.push([
      'fn = ',
      this.decorators.functionCall('decorator', '', ['fn', 'props', 'container', options]),
      ' || fn;'
    ]);
  },
  ...
  invokePartial: function(isDynamic, name, indent) {
    ...
    if (!isDynamic) {
      // Only resolve partials that are own properties of the partials object.
      // Reading inherited properties would let a polluted Object.prototype
      // inject arbitrary partials (GHSA-2qvq-rjwj-gvw9).
      params.unshift([
        '(Object.prototype.hasOwnProperty.call(partials, ',
        JSON.stringify(name),
        ') ? ',
